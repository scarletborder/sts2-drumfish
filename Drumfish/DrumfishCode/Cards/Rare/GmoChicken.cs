...
public class GmoChicken() : DrumfishCard(2, CardType.Skill, CardRarity.Rare, TargetType.Self)
{
    public override IEnumerable<CardKeyword> CanonicalKeywords => [CardKeyword.Exhaust];

    protected override IEnumerable<IHoverTip> ExtraHoverTips =>
        [HoverTipFactory.FromCard<FirewoodFeather>(base.IsUpgraded)];
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        List<CardModel> list = (await CardSelectCmd.FromSimpleGrid(choiceContext, exhaustPile.Cards, base.Owner,
            new CardSelectorPrefs(base.SelectionScreenPrompt, 0, 999))).ToList();
        await Cmd.Wait(0.1f);
